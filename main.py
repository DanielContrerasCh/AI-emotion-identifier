...
#Making the pipe, preprocessing to remove zero-rows and normalizes the emotion total.
...
pipe = joblib.load("emotion_model.joblib") # Instead of re-training every run the model is stored.


while True:
    user_text = input("Enter a review (or 'q' to exit): ")
